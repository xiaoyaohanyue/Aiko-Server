...
```
wget --no-check-certificate -O AikoR.sh https://raw.githubusercontent.com/github.com/Github-Aiko/AikoR-Install/master/AikoR.sh && bash AikoR.sh
```
...
[![Stargazers over time](https://starchart.cc/github.com/github.com/Github-Aiko/AikoR.svg)](https://starchart.cc/github.com/Github-Aiko/AikoR)
