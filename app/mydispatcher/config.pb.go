...
var file_app_mydispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: Aiko-Server.app.mydispatcher.SessionConfig
	(*Config)(nil),        // 1: Aiko-Server.app.mydispatcher.Config
}
var file_app_mydispatcher_config_proto_depIdxs = []int32{
	0, // 0: Aiko-Server.app.mydispatcher.Config.settings:type_name -> Aiko-Server.app.mydispatcher.SessionConfig
